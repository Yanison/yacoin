						...
						<c:otherwise>
							<c:forEach items="${emplist}" var="emplist" varStatus="status">
								<tr>
									...
									<td><c:out value="${emplist.empcgseq }"/></td>
									<td><c:out value="${emplist.empcgname }"/></td>
									<td><c:out value="${emplist.empcgnameEng }"/></td>
									<td><c:out value="${emplist.empccgseq }"/></td>
									<td><c:out value="${emplist.empccgname }"/></td>
									<td><c:out value="${emplist.cg_empcxg }"/></td>
									<td></td>
								</tr>		
							</c:forEach>
					</c:otherwise>
