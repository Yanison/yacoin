...
<div class="body-wrapper">
	...
	<div class="right-wrapper">  
		...
		<!-- 코드그룹관리 s-->
		<section class="right empTable" style="display:none;">
			<%@ include file="codeGroupListEmp.jsp" %>
		</section>
		
		<section class="right isTable" style="display:none;">
			<%@ include file="codeGroupList.jsp" %>
		</section>
		
		<section class="right codeManage" style="display:block;">
			<%@ include file="codeGroupListVo.jsp" %>
		</section>
		<!-- 코드그룹관리 e-->
		
		<!-- 멤버관리 s-->
		<section class="right memberInfo" style="display:none;">
